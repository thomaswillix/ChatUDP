...
public class Client extends Application {
    ...
    private static final String identifier = "Thomas";
    ...
    public static void main(String[] args) {
        ...
        byte[] uid = ("init;" + identifier).getBytes();
        DatagramPacket initialize = new DatagramPacket(uid, uid.length, address, SERVER_PORT);
